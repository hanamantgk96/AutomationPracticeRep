...
public class CreateOrderStepDefinition {
	...
	public CreateOrderStepDefinition(Setuptest testSetup) {
		this.testsetup = testSetup;
	}
	
	@Given("Navigate to place order page")
	public void navigate_to_place_order_page() throws InterruptedException {
		CreateOrder order = testsetup.pageObjectManager.getCreateOrder();
	    order.clickgrid();
	    Thread.sleep(1000);

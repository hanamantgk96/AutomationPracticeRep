...
public class CreateOrder {
	...
	public void selectbusinessrandomaly() throws InterruptedException {
		...
		public void draftorder() throws InterruptedException {
			WebElement toastElement = driver.findElement(By.cssSelector("div.toast.show"));
	        String toastText = toastElement.getText();

	        int idIndex = toastText.indexOf("ID : ");
	        String draftIdNumber = toastText.substring(idIndex + 4).trim();

	        System.out.println("Draft Order created successfully with order ID: " + draftIdNumber);
	        ...
	        Thread.sleep(1000);
	        driver.findElement(By.xpath("//ul//li//span[text()='Draft Orders']")).click();
	        Thread.sleep(2000);

	        WebElement searchInputField = driver.findElement(By.xpath("(//input[@type='text'])[1]"));
	        Thread.sleep(1000);
	        searchInputField.sendKeys(draftIdNumber);
	        Thread.sleep(1000);
		...
		public void Businessfilteration() {
			...
			WebElement tradeNameInput = driver.findElement(By.xpath("//input[@title=\"Trade Name's filter bar cell\"]")); 

			tradeNameInput.sendKeys("BATEEL INTERNATIONAL LLC");
		...
		public void Productfilteration() throws InterruptedException {
			
			WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
		    
		    WebElement Prd_id = driver.findElement(By.xpath("(//div[@class='grid-text-input']//input)[1]")); 
		    Prd_id.sendKeys("13352");
		    Prd_id.sendKeys(Keys.ENTER);
		    Thread.sleep(1000);
		    
		    wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//*[@class='grid-checkbox-input']")));
		    
		    WebElement firstCheckbox = driver.findElement(By.xpath("//*[@class='grid-checkbox-input']"));
		    firstCheckbox.click();
		    Thread.sleep(1000);
		    
		    driver.findElement(By.xpath("(//div[@class='grid-text-input']//input)[1]")).clear();
		    Prd_id.sendKeys(Keys.ENTER);
		    Thread.sleep(2000);

		    // ✅ **Re-locate checkbox before validation to avoid Stale Element Reference**
		    firstCheckbox = driver.findElement(By.xpath("//*[@class='grid-checkbox-input']"));

		    WebElement Prd_Name = driver.findElement(By.xpath("(//div[@class='grid-text-input']//input)[2]")); 
		    Prd_Name.sendKeys("Fresh Sea Bass Whole 600-800");
		    Prd_Name.sendKeys(Keys.ENTER);
		    Thread.sleep(1000);
		    
		    wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//*[@class='grid-checkbox-input']")));
		    
		    WebElement secondCheckbox = driver.findElement(By.xpath("//*[@class='grid-checkbox-input']"));
		    secondCheckbox.click();
		    Thread.sleep(1000);
		    
		    secondCheckbox = driver.findElement(By.xpath("//*[@class='grid-checkbox-input']"));

		    if (secondCheckbox.isSelected()) {
		        System.out.println("Status Passed: Product Name and Product id filtered successfully and selected.");
		    } else {
		        System.out.println("Status Failed: Product Name selection failed.");
		    }
		}
	...
	public void Lpo_Num_popupErrorValidation() throws InterruptedException {
		...
		Thread.sleep(1000);
			...
			if (LPONumberField.getAttribute("value").isEmpty()) {
				...
				LPONumberField.sendKeys("10-march-2025");
				Thread.sleep(1000);

				if (!LPONumberField.getAttribute("value").isEmpty()) {
					System.out.println("Status Passed");
				} else {
					System.out.println("Test Case Failed: LPO Number is should not be empty.");
				}
			}
	}
...
//	}
	...
	public void validateTotalAmount(double prdValu) throws InterruptedException {
		...
		Thread.sleep(1000);
		driver.findElement(By.xpath("//button[text()='Yes']")).click(); //click dublicate LPO number
